(function (root) {
  ...
  layout.artworkPlacement = Object.freeze({
    ...
    background: Object.freeze({ mode: "single-map-authoritative", x: 0, y: 0, w: reference.width, h: reference.height, scale: 1 }),
    foreground: Object.freeze({ mode: "single-map-occlusion-v2", x: 0, y: 0, w: reference.width, h: reference.height, scale: 1 }),
  });
