(() => {
  ...
  const files = {
    ...
    down: RAW + 'shion_walk_down.png',
    up: RAW + 'shion_walk_up.png',
    left: RAW + 'shion_walk_left.png',
    right: RAW + 'shion_walk_right.png'
  };
  ...
  // The map remains one image. These masks redraw only the visible foreground
  // portions after Shion, creating 2.5D occlusion without new art assets.
