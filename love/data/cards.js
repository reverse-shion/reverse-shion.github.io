...
window.BRIDGE_PATTERNS = {
  ambiguous: [
    ...
    "このまま一人で考え続けるより、一度きちんと見てもらうことで、『今の自分がどうしたいのか』まで整理しやすくなります。"
  ],
  progress: [
    "今見えているのは、この恋にある前向きな流れです。ただ、相手の気持ちの深さや、この先どう育てるべきかまでは、もう少し具体的に見た方が分かりやすくなります。",
    "良い流れがあるときほど、どう関わるかで未来が変わります。そこを自分の状況に合わせて整理したい方に、個人鑑定は向いています。",
  ...
  turningPoint: [
    ...
    "『まだ待つべきか』『ここで動くべきか』を曖昧なままにしたくないとき、個人鑑定が役立ちます。"
  ],
  painful: [
    ...
    "『どうしてこんなに苦しいのか』を一人で抱え続けるより、一度きちんと見てもらうことで気持ちがほどけやすくなります。"
  ]
};
