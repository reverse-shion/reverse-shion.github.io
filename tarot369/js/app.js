const CONFIG = {
  consultationUrl: "../consultation/index.html",
  lineUrl: "https://lin.ee/LYnlU0f",
...
const TOPIC_COPY = {
  self: {
    ...
    bridge:
      "この一枚は、今の心に必要な入口の言葉です。相手の気持ち、関係の流れ、仕事や人間関係の具体的な選択まで見たい場合は、個人鑑定で状況に合わせて丁寧に読み解けます。"
  },
  love: {
    label: "恋愛について",
    hint: "相手の気持ち、関係の流れ、自分の本音を一枚から受け取ります。",
    bridge:
      "この一枚は、今の心に必要な入口の言葉です。相手の本音や連絡の意味、待つべきか動くべきかまで見たい場合は、個人鑑定で状況に合わせて丁寧に読み解けます。"
  },
  work: {
    label: "仕事・活動について",
    hint: "今の活動、仕事、進む方向に必要な言葉を受け取ります。",
    bridge:
      "この一枚は、今の心に必要な入口の言葉です。何を優先するか、どこを整えるか、今後どう動くかまで見たい場合は、個人鑑定で状況に合わせて丁寧に読み解けます。"
  },
  relation: {
    label: "人間関係について",
    hint: "人との距離感、言葉、関係性に必要なメッセージを受け取ります。",
    bridge:
      "この一枚は、今の心に必要な入口の言葉です。相手の本音や距離感、これからの関わり方まで見たい場合は、個人鑑定で状況に合わせて丁寧に読み解けます。"
  }
};
...
function renderCard(card) {
  ...
  elements.consultSafeNote.textContent =
    "まずは個人鑑定ページで、流れや料金、安心材料を確認してからご検討いただけます。";
